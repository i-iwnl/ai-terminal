...
**すべての完了条件を満たし、出荷まで完了した。エージェント側の作業は残っていない。**

| 項目 | 状態 |
|---|---|
| 実装・検証・文書 | **完了** |
| commit / push | **完了**（`bebdec1`。周6-a / 6-b / 7 を1コミットに。理由は `worklog.md`） |
| PR | **[#245](https://github.com/i-iwnl/ai-terminal/pull/245)**（`Closes #244`）。**マージは人が行う** |
| Issue への書き戻し | **完了**（完了条件の字面を外した理由3点を含む） |
| known-issues の起票 | **完了** -> #246 / #247 / #248 / #249。9番は **#195 の A-7 へ集約**（起票しない） |
